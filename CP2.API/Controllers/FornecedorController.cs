...
namespace CP2.API.Controllers
{
    ...
    public class FornecedorController : ControllerBase
    {
        ...
        public IActionResult Get()
        {
            ...
            return objModel is not null ? Ok(objModel) : BadRequest("Não foi possivel obter os dados");
        }
        ...
        public IActionResult Post([FromBody] FornecedorDto entity)
        {
            try
            {
                ...
                return objModel is not null ? Ok(objModel) : BadRequest("Não foi possivel salvar os dados");
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Delete(int id)
        {
            ...
            return objModel is not null ? Ok(objModel) : BadRequest("Não foi possivel deletar os dados");
        }
    }
}
